...
from data_preprocess import load_and_process_data_mnist, load_and_process_data_housing, load_and_process_data_emotion, load_and_process_data_emotion_new ,load_and_process_data_emotion_test,load_and_process_data_emotion_lbp,load_and_process_data_emotion_test_lbp
...
if __name__ == '__main__':
    ...
    _, x_test_new, y_test_new = load_and_process_data_emotion_test_lbp()
